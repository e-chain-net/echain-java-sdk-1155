...
public class Define {
//    public static final String UrlBase = "http://10.168.3.30:8080";
    public static final String UrlBase = "https://qa-api.e-chain.net.cn";
    public static final String UrlQuery = UrlBase + "/chain/rpc/query";
    public static final String UrlSendTx = UrlBase + "/chain/rpc/tx";
    public static final String UrlDeploy = UrlBase + "/chain/contract/deploy";

    public static final String MerchantNo = "3203001000583086614";
    ...
    public static final String ContractAddress = "0xc9e086ef258954837536abfe1f4f73d64bba4841";
}
